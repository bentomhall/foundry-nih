export default class TokenRuler5e extends foundry.canvas.placeables.tokens.TokenRuler {
  ...
  #getSpeedBasedStyle(waypoint, style) {
    ...
    if ( CONFIG.NIH.movementTypes[waypoint.action]?.walkFallback
      || !CONFIG.NIH.movementTypes[waypoint.action] ) {
    ...
    const { normal, double, triple } = CONFIG.NIH.tokenRulerColors;
