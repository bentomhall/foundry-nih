...
export default class BaseSaveActivityData extends BaseActivityData {
  ...
  /** @override */
  get ability() {
    if ( this.save.dc.calculation in CONFIG.NIH.abilities ) return this.save.dc.calculation;
  ...
  static transformTypeData(source, activityData, options) {
    ...
    return foundry.utils.mergeObject(activityData, {
      ...
      save: {
        ability: [source.system.save?.ability || Object.keys(CONFIG.NIH.abilities)[0]],
        dc: {
          calculation,
  ...
  prepareFinalData(rollData) {
    ...
    if ( this.save.dc.value ) this.labels.save = game.i18n.format("NIH.SaveDC", {
