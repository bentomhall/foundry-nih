...
export default class DetailsField {
  ...
  static get common() {
    return {
      biography: new foundry.data.fields.SchemaField({
        value: new foundry.data.fields.HTMLField({label: "NIH.Biography"}),
        public: new foundry.data.fields.HTMLField({label: "NIH.BiographyPublic"})
      }, {label: "NIH.Biography"})
    };
  }
  ...
  static get creature() {
    return {
      alignment: new foundry.data.fields.StringField({required: true, label: "NIH.Alignment"}),
      race: new foundry.data.fields.StringField({required: true, label: "NIH.Race"})
    };
  }
}
