...
export default class RuleJournalPageData extends foundry.abstract.TypeDataModel {
  ...
  static defineSchema() {
    return {
      tooltip: new HTMLField({textSearch: true, label: "NIH.Rule.Tooltip"}),
      type: new StringField({blank: false, initial: "rule", label: "NIH.Rule.Type.Label"})
    };
  }
  ...
  async richTooltip(enrichmentOptions={}) {
    const context = {
      page: this.parent,
      type: CONFIG.NIH.ruleTypes[this.type].label,
    ...
    return {
      content: await foundry.applications.handlebars.renderTemplate(
        "systems/nih/templates/journal/page-rule-tooltip.hbs", context
      ),
      classes: ["nih-tooltip", "rule-tooltip", "nih2", "themed", "theme-light"]
    };
  }
