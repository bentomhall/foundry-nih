 ...
 *
 * @property {string} weaponType   Weapon category as defined in `NIH.weaponTypes`.
 * @property {string} baseItem     Base weapon as defined in `NIH.weaponIds` for determining proficiency.
...
export default class WeaponData extends SystemDataModel.mixin(
  ...
  static defineSchema() {
    return this.mergeSchema(super.defineSchema(), {
      weaponType: new foundry.data.fields.StringField({
        required: true, initial: "simpleM", label: "NIH.ItemWeaponType"
      }),
      baseItem: new foundry.data.fields.StringField({required: true, blank: true, label: "NIH.ItemWeaponBase"}),
      properties: new MappingField(new foundry.data.fields.BooleanField(), {
        required: true, initialKeys: CONFIG.NIH.weaponProperties, label: "NIH.ItemWeaponProperties"
      }),
   ...
   */
  get chatProperties() {
    return [CONFIG.NIH.weaponTypes[this.weaponType]];
  }
  ...
  get proficiencyMultiplier() {
    ...
    const improvised = (this.weaponType === "improv") && !!actor.getFlag("nih", "tavernBrawlerFeat");
