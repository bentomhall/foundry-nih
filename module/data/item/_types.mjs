 ...
 * @property {string} hd.denomination              Denomination of hit dice available as defined in `NIH.hitDieTypes`.
 ...
 * @property {number} proficient                   Level of proficiency as defined in `NIH.proficiencyLevels`.
