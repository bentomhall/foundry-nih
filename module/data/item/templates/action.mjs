 ...
 * @property {string} actionType          Action type as defined in `NIH.itemActionTypes`.
  ...
  static defineSchema() {
    return {
      ability: new foundry.data.fields.StringField({
        required: true, nullable: true, initial: null, label: "NIH.AbilityModifier"
      }),
      actionType: new foundry.data.fields.StringField({
        required: true, nullable: true, initial: null, label: "NIH.ItemActionType"
      }),
      attackBonus: new FormulaField({required: true, label: "NIH.ItemAttackBonus"}),
      chatFlavor: new foundry.data.fields.StringField({required: true, label: "NIH.ChatFlavor"}),
      critical: new foundry.data.fields.SchemaField({
        threshold: new foundry.data.fields.NumberField({
          required: true, integer: true, initial: null, positive: true, label: "NIH.ItemCritThreshold"
        }),
        damage: new FormulaField({required: true, label: "NIH.ItemCritExtraDamage"})
      }),
      damage: new foundry.data.fields.SchemaField({
        ...
        versatile: new FormulaField({required: true, label: "NIH.VersatileDamage"})
      }, {label: "NIH.Damage"}),
      formula: new FormulaField({required: true, label: "NIH.OtherFormula"}),
      save: new foundry.data.fields.SchemaField({
        ability: new foundry.data.fields.StringField({required: true, blank: true, label: "NIH.Ability"}),
        dc: new foundry.data.fields.NumberField({
          required: true, min: 0, integer: true, label: "NIH.AbbreviationDC"
        }),
        scaling: new foundry.data.fields.StringField({
          required: true, blank: false, initial: "spell", label: "NIH.ScalingFormula"
        })
      }, {label: "NIH.SavingThrow"})
    };
  }
