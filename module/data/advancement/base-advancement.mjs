  ...
  static defineSchema() {
    return {
      ...
      level: new foundry.data.fields.NumberField({
        integer: true, initial: this.metadata?.multiLevel ? undefined : 1, min: 0, label: "NIH.Level"
      }),
      title: new foundry.data.fields.StringField({initial: undefined, label: "NIH.AdvancementCustomTitle"}),
      icon: new foundry.data.fields.FilePathField({
        initial: undefined, categories: ["IMAGE"], label: "NIH.AdvancementCustomIcon"
      }),
