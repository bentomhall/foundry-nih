...
export default class SpellConfigurationData extends foundry.abstract.DataModel {
  ...
  static defineSchema() {
    return {
      ...
      preparation: new foundry.data.fields.StringField({label: "NIH.SpellPreparationMode"}),
      uses: new foundry.data.fields.SchemaField({
        max: new FormulaField({deterministic: true, label: "NIH.UsesMax"}),
        per: new foundry.data.fields.StringField({label: "NIH.UsesPeriod"})
