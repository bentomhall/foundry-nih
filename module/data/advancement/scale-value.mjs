...
export class ScaleValueConfigurationData extends foundry.abstract.DataModel {
  ...
  /** @override */
  static LOCALIZATION_PREFIXES = ["NIH.ADVANCEMENT.ScaleValue"];
...
export class ScaleValueType extends foundry.abstract.DataModel {
  ...
  /** @override */
  static LOCALIZATION_PREFIXES = ["NIH.ADVANCEMENT.ScaleValue.Type.String"];
  ...
  static get metadata() {
    return {
      label: "NIH.ADVANCEMENT.ScaleValue.Type.String.Label",
      hint: "NIH.ADVANCEMENT.ScaleValue.Type.String.Hint",
      identifier: "NIH.ADVANCEMENT.ScaleValue.Type.String.Identifier",
      isNumeric: false
    };
  }
...
export class ScaleValueTypeNumber extends ScaleValueType {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      label: "NIH.ADVANCEMENT.ScaleValue.Type.Number.Label",
      hint: "NIH.ADVANCEMENT.ScaleValue.Type.Number.Hint",
      isNumeric: true
    });
  }
...
export class ScaleValueTypeCR extends ScaleValueTypeNumber {
  ...
  /** @override */
  static LOCALIZATION_PREFIXES = ["NIH.ADVANCEMENT.ScaleValue.Type.CR"];
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      label: "NIH.ADVANCEMENT.ScaleValue.Type.CR.Label",
      hint: "NIH.ADVANCEMENT.ScaleValue.Type.CR.Hint"
    });
  }
...
export class ScaleValueTypeDice extends ScaleValueType {
  ...
  /** @override */
  static LOCALIZATION_PREFIXES = ["NIH.ADVANCEMENT.ScaleValue.Type.Dice"];
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      label: "NIH.ADVANCEMENT.ScaleValue.Type.Dice.Label",
      hint: "NIH.ADVANCEMENT.ScaleValue.Type.Dice.Hint",
      identifier: "NIH.ADVANCEMENT.ScaleValue.Type.Dice.Identifier"
    });
  }
  ...
  get mods() {
    ...
    return this.modifiers.reduce((acc, mod) => {
      return acc + (nih.utils.isValidDieModifier(mod) ? mod : "");
    }, "");
  }
...
export class ScaleValueTypeDistance extends ScaleValueTypeNumber {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      label: "NIH.ADVANCEMENT.ScaleValue.Type.Distance.Label",
      hint: "NIH.ADVANCEMENT.ScaleValue.Type.Distance.Hint"
    });
  }
