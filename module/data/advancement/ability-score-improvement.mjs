...
export class AbilityScoreImprovementConfigurationData extends foundry.abstract.DataModel {
  ...
  /** @override */
  static LOCALIZATION_PREFIXES = ["NIH.ADVANCEMENT.AbilityScoreImprovement"];
...
export class AbilityScoreImprovementValueData extends SparseDataModel {
  ...
  static defineSchema() {
    return {
      ...
      feat: new MappingField(new StringField(), { required: false, initial: undefined, label: "NIH.Feature.Feat" })
    };
  }
}
