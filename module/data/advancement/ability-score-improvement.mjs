  ...
  static defineSchema() {
    return {
      ...
      points: new foundry.data.fields.NumberField({
        ...
        label: "NIH.AdvancementAbilityScoreImprovementPoints",
        hint: "NIH.AdvancementAbilityScoreImprovementPointsHint"
      }),
      fixed: new MappingField(
        new foundry.data.fields.NumberField({nullable: false, integer: true, initial: 0}),
        {label: "NIH.AdvancementAbilityScoreImprovementFixed"}
      )
    };
  }
}
  ...
  static defineSchema() {
    return {
      ...
      feat: new MappingField(new foundry.data.fields.StringField(), {
        required: false, initial: undefined, label: "NIH.Feature.Feat"
      })
    };
  }
}
