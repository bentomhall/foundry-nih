...
export default class CalendarData5e extends foundry.data.CalendarData {
  ...
  static formatApproximateDate(calendar, components, options) {
    ...
    return game.i18n.format(`NIH.CALENDAR.Formatters.ApproximateDate.${formatter}Season`, {
  ...
  static formatApproximateTime(calendar, components, options) {
    ...
    return game.i18n.localize(`NIH.CALENDAR.Formatters.ApproximateTime.${formatter}`);
  }
  ...
  static formatHoursMinutes(calendar, components, options) {
    return CalendarData5e.formatLocalized(
      "NIH.CALENDAR.Formatters.HoursMinutes.Format", calendar, components, options
    );
  }
  ...
  static formatHoursMinutesSeconds(calendar, components, options) {
    return CalendarData5e.formatLocalized(
      "NIH.CALENDAR.Formatters.HoursMinutesSeconds.Format", calendar, components, options
    );
  }
  ...
  static formatMonthDay(calendar, components, options) {
    return CalendarData5e.formatLocalized(
      "NIH.CALENDAR.Formatters.MonthDay.Format", calendar, components, options
    );
  }
  ...
  static formatMonthDayYear(calendar, components, options) {
    return CalendarData5e.formatLocalized(
      "NIH.CALENDAR.Formatters.MonthDayYear.Format", calendar, components, options
    );
  }
  ...
  static onUpdateWorldTime(worldTime, deltaTime, options, userId) {
    ...
    foundry.utils.setProperty(options, "nih.deltas", {
      midnights: days,
