...
export default class EnchantSheet extends ActivitySheet {
  ...
  static PARTS = {
    ...super.PARTS,
    effect: {
      template: "systems/nih/templates/activity/enchant-effect.hbs",
      templates: [
        "systems/nih/templates/activity/parts/enchant-enchantments.hbs",
        "systems/nih/templates/activity/parts/enchant-restrictions.hbs"
      ]
    }
  };
  ...
  async _prepareEffectContext(context, options) {
    ...
    context.typeOptions = [
      { value: "", label: game.i18n.localize("NIH.ENCHANT.FIELDS.restrictions.type.Any"), rule: true },
    ...
    context.propertyOptions = (CONFIG.NIH.validProperties[type] ?? [])
      .map(value => ({ value, label: CONFIG.NIH.itemProperties[value]?.label ?? value }));
  ...
  _getTabs() {
    ...
    tabs.effect.label = "NIH.ENCHANT.SECTIONS.Enchanting";
    ...
    tabs.effect.tabs = this._markTabs({
      enchantments: {
        ...
        label: "NIH.ENCHANT.SECTIONS.Enchantments"
      },
      restrictions: {
        id: "restrictions", group: "effect", icon: "fa-solid fa-ban",
        label: "NIH.ENCHANT.SECTIONS.Restrictions"
      }
    });
    return tabs;
  }
