...
export default class AttackRollConfigurationDialog extends D20RollConfigurationDialog {
  ...
  async _prepareConfigurationContext(context, options) {
    ...
    const optionsFields = [
      { key: "attackMode", label: "NIH.ATTACK.Mode.Label", options: this.options.attackModeOptions },
      { key: "ammunition", label: "NIH.CONSUMABLE.Type.Ammunition.Label", options: this.options.ammunitionOptions },
      { key: "mastery", label: "NIH.WEAPON.Mastery.Label", options: this.options.masteryOptions }
    ];
    context.fields = [
