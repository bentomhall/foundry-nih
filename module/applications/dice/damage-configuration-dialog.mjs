...
export default class DamageRollConfigurationDialog extends RollConfigurationDialog {
  ...
  static PARTS = {
    ...super.PARTS,
    formulas: {
      template: "systems/nih/templates/dice/damage-formulas.hbs"
    }
  };
  ...
  async _prepareFormulasContext(context, options) {
    ...
    const allTypes = foundry.utils.mergeObject(CONFIG.NIH.damageTypes, CONFIG.NIH.healingTypes, { inplace: false });
