...
export default class BastionSettingsConfig extends BaseSettingsConfig {
  ...
  static DEFAULT_OPTIONS = {
    window: {
      title: "NIH.Bastion.Configuration.Label"
    }
  };
  ...
  static PARTS = {
    ...super.PARTS,
    config: {
      template: "systems/nih/templates/settings/bastion-config.hbs"
    }
  };
  ...
  async _preparePartContext(partId, context, options) {
    ...
    context.source = game.settings.get("nih", "bastionConfiguration");
    return context;
  }
}
