...
function _generateLinks() {
  ...
  links.innerHTML = `
    <li>
      <a href="https://github.com/foundryvtt/nih/releases/latest" target="_blank">
        ${game.i18n.localize("NIH.Notes")}
      </a>
    </li>
    <li>
      <a href="https://github.com/foundryvtt/nih/issues" target="_blank">${game.i18n.localize("NIH.Issues")}</a>
    </li>
    <li>
      <a href="https://github.com/foundryvtt/nih/wiki" target="_blank">${game.i18n.localize("NIH.Wiki")}</a>
    </li>
    <li>
      <a href="https://discord.com/channels/170995199584108546/670336046164213761" target="_blank">
        ${game.i18n.localize("NIH.Discord")}
      </a>
    </li>
  `;
  return links;
...
export function renderSettings(html) {
  ...
  section.classList.add("nih2", "sidebar-info");
  section.innerHTML = `
    <h4 class="divider">${game.i18n.localize("WORLD.FIELDS.system.label")}</h4>
    <div class="system-badge">
      <img src="systems/nih/ui/official/dnd-badge-32.webp" data-tooltip="${nih.title}" alt="${nih.title}">
      <span class="system-info">${nih.version}</span>
    </div>
  `;
