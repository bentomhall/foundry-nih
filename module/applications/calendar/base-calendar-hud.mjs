...
export default class BaseCalendarHUD extends Application5e {
  ...
  static get shouldDisplay() {
    return (game.settings.get("nih", "calendarConfig")?.enabled || false)
      && (game.settings.get("nih", "calendarPreferences")?.visible || false);
  }
  ...
  static onUpdateWorldTime(worldTime, deltaTime, options, userId) {
    if ( this.shouldDisplay ) nih.ui.calendar?.render();
  }
}
