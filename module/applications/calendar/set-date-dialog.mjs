...
export default class SetDateDialog extends Dialog5e {
  ...
  static DEFAULT_OPTIONS = {
    ...
    window: {
      title: "NIH.CALENDAR.Action.SetDate"
    }
  };
  ...
  static PARTS = {
    ...super.PARTS,
    content: {
      template: "systems/nih/templates/apps/set-date-dialog.hbs"
    }
  };
    ...
    context.fields = [
      {
        ...
        label: game.i18n.localize("NIH.CALENDAR.Component.Year"),
        name: "year",
      ...
      },
      {
        ...
        label: game.i18n.localize("NIH.CALENDAR.Component.Month"),
        name: "month",
      ...
      },
      {
        ...
        label: game.i18n.localize("NIH.CALENDAR.Component.Day"),
        name: "day",
        value: dayOfMonth + 1
      }
    ];
