 ...
 * @deprecated since nih 2.1, targeted for removal in 2.3
 */
export default class TraitSelector extends DocumentSheet {
  constructor(...args) {
    ...
    if ( !this.options.suppressWarning ) foundry.utils.logCompatibilityWarning(
      ...
      + "available at 'nih.applications.actor.TraitSelector'. Support for the old application will "
      + "be removed in a future version.",
      { since: "Nih 2.1", until: "Nih 2.3" }
    );
  }
