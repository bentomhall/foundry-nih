...
export default class SourceConfig extends DocumentSheet5e {
  ...
  static PARTS = {
    source: {
      template: "systems/nih/templates/apps/source-config.hbs"
    },
    footer: {
  ...
  /** @override */
  get title() {
    return game.i18n.localize("NIH.SOURCE.Action.Configure");
  }
  ...
  async _prepareContext(options) {
    ...
    context.rulesVersions = [
      { value: "", label: "" },
      { value: "2024", label: game.i18n.localize("SETTINGS.NIH.RULESVERSION.Modern") },
      { value: "2014", label: game.i18n.localize("SETTINGS.NIH.RULESVERSION.Legacy") }
    ];
