...
export default class CreatureTypeConfig extends BaseConfigSheet {
  ...
  static PARTS = {
    config: {
      template: "systems/nih/templates/shared/config/creature-type-config.hbs"
    }
  };
  ...
  /** @override */
  get title() {
    return game.i18n.localize("NIH.CreatureType");
  }
  ...
  async _preparePartContext(partId, context, options) {
    ...
    context.swarmOptions = [
      { value: "", label: "" },
      ...Object.entries(CONFIG.NIH.actorSizes).map(([value, { label }]) => ({ value, label })).reverse()
    ];
    context.typeOptions = Object.entries(CONFIG.NIH.creatureTypes)
