...
export default class ShortRestDialog extends BaseRestDialog {
  ...
  static PARTS = {
    ...super.PARTS,
    content: {
      template: "systems/nih/templates/actors/rest/short-rest.hbs"
    }
  };
  ...
  async _prepareContext(options) {
    ...
    context.autoRoll = new BooleanField({
      label: game.i18n.localize("NIH.REST.HitDice.AutoSpend.Label"),
      hint: game.i18n.localize("NIH.REST.HitDice.AutoSpend.Hint")
    });
    ...
    if ( this.actor.type === "npc" ) {
      ...
      context.hitDice = {
        ...
        options: [{
          ...
          label: `d${hd.denomination} (${game.i18n.format("NIH.HITDICE.Available", { number: hd.value })})`
        }]
      };
    }
      ...
      context.hitDice = {
        ...
        options: Object.entries(this.actor.system.attributes.hd.bySize).map(([value, number]) => ({
          value, label: `${value} (${game.i18n.format("NIH.HITDICE.Available", { number })})`, number
        }))
      };
