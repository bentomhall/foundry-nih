...
export default class LongRestDialog extends BaseRestDialog {
  ...
  static PARTS = {
    ...super.PARTS,
    content: {
      template: "systems/nih/templates/actors/rest/long-rest.hbs"
    }
  };
  ...
  async _prepareContext(options) {
    ...
    const { enabled } = game.settings.get("nih", "bastionConfiguration");
    if ( game.user.isGM && context.isGroup && enabled ) context.fields.unshift({
      field: new BooleanField({ label: game.i18n.localize("NIH.Bastion.Action.BastionTurn") }),
