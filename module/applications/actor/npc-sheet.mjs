...
export default class ActorSheet5eNPC extends ActorSheet5e {
  ...
  _prepareItems(context) {
    ...
    const features = {
      weapons: { label: game.i18n.localize("NIH.AttackPl"), items: [], hasActions: true,
        dataset: {type: "weapon", "weapon-type": "natural"} },
      actions: { label: game.i18n.localize("NIH.ActionPl"), items: [], hasActions: true,
        dataset: {type: "feat", "activation.type": "action"} },
      passive: { label: game.i18n.localize("NIH.Features"), items: [], dataset: {type: "feat"} },
      equipment: { label: game.i18n.localize("NIH.Inventory"), items: [], dataset: {type: "loot"}}
    };
  ...
  getArmorLabel() {
    ...
    const label = [];
    if ( ac.calc === "default" ) label.push(this.actor.armor?.name || game.i18n.localize("NIH.ArmorClassUnarmored"));
    else label.push(game.i18n.localize(CONFIG.NIH.armorClasses[ac.calc].label));
