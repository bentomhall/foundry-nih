...
export default class ConcentrationConfig extends BaseConfigSheet {
  ...
  static PARTS = {
    config: {
      template: "systems/nih/templates/actors/config/concentration-config.hbs"
    }
  };
  ...
  /** @override */
  get title() {
    return game.i18n.format("NIH.ABILITY.Configure.Title", { ability: game.i18n.localize("NIH.Concentration") });
  }
  ...
  async _preparePartContext(partId, context, options) {
    ...
    const ability = CONFIG.NIH.abilities[CONFIG.NIH.defaultAbilities.concentration]?.label?.toLowerCase();
    context.abilityOptions = [
      { value: "", label: ability ? game.i18n.format("NIH.DefaultSpecific", { default: ability }) : "" },
      { rule: true },
