...
export default class TraitsConfig extends BaseConfigSheet {
  ...
  static PARTS = {
    traits: {
      template: "systems/nih/templates/actors/config/traits-config.hbs"
    }
  };
   ...
   */
  get otherLabel() {
    return game.i18n.localize("NIH.ProficiencyOther");
  }
  ...
  _initializeApplicationOptions(options) {
    ...
    if ( !CONFIG.NIH.traits[options.trait] ) throw new Error(
      `Cannot instantiate TraitsConfig with a trait not defined in CONFIG.NIH.traits: ${options.trait}.`
    );
  ...
  _processFormData(event, form, formData) {
    ...
    if ( !CONFIG.NIH.traits[this.options.trait].dataType ) {
