...
export default class HabitatConfig extends BaseConfigSheet {
  ...
  static PARTS = {
    config: {
      template: "systems/nih/templates/actors/config/habitat-config.hbs"
    }
  };
  ...
  /** @override */
  get title() {
    return game.i18n.localize("NIH.Habitat.Configuration.Title");
  }
  ...
  async _prepareContext(options) {
    ...
    const config = CONFIG.NIH.habitats;
