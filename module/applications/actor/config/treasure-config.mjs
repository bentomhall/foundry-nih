...
export default class TreasureConfig extends BaseConfigSheet {
  ...
  static PARTS = {
    config: {
      template: "systems/nih/templates/actors/config/treasure-config.hbs"
    }
  };
  ...
  /** @override */
  get title() {
    return game.i18n.localize("NIH.Treasure.Configuration.Title");
  }
  ...
  async _prepareContext(options) {
    ...
    const config = CONFIG.NIH.treasure;
