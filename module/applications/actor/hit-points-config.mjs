...
export default class ActorHitPointsConfig extends BaseConfigSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["nih", "actor-hit-points-config"],
      template: "systems/nih/templates/apps/hit-points-config.hbs",
      width: 320,
      height: "auto",
      sheetConfig: false
    });
  ...
  /** @inheritdoc */
  get title() {
    return `${game.i18n.localize("NIH.HitPointsConfig")}: ${this.document.name}`;
  }
  ...
  async _onRollHPFormula(event) {
    ...
    try {
      ...
      ui.notifications.error(game.i18n.localize("NIH.HPFormulaError"));
      throw error;
    }
  }
}
