...
export default class ActorArmorConfig extends BaseConfigSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["nih", "actor-armor-config"],
      template: "systems/nih/templates/apps/actor-armor.hbs",
      width: 320,
      height: "auto",
      sheetConfig: false
    });
  ...
  /** @inheritdoc */
  get title() {
    return `${game.i18n.localize("NIH.ArmorConfig")}: ${this.document.name}`;
  }
  ...
  async getData() {
    ...
    return {
      ac, isFlat,
      calculations: CONFIG.NIH.armorClasses,
