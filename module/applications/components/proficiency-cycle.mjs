...
export default class ProficiencyCycleElement extends AdoptedStyleSheetMixin(
  ...
  static CSS = `
    ...
    div { --_fill: var(--proficiency-cycle-enabled-color, var(--nih-color-blue)); }
    div:has(:disabled, :focus-visible) { --_fill: var(--proficiency-cycle-disabled-color, var(--nih-color-gold)); }
  ...
  _refresh() {
    ...
    this._internals.ariaValueText = CONFIG.NIH.proficiencyLevels[this._value];
