...
export default class CopyableTextElement extends (foundry.applications.elements.AdoptableHTMLElement ?? HTMLElement) {
  ...
  connectedCallback() {
    ...
    button.ariaLabel = this.getAttribute("label") ?? game.i18n.localize("NIH.Copy");
  ...
  _onClick(event) {
    ...
    game.tooltip.activate(event.target, { text: game.i18n.format("NIH.Copied", { value }), direction: "UP" });
  }
}
