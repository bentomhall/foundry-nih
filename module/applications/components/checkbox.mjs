...
export default class CheckboxElement extends AdoptedStyleSheetMixin(
  ...
  static CSS = `
    ...
    :host > div {
      ...
      border: var(--checkbox-border-width, 2px) solid var(--checkbox-border-color, var(--nih-color-gold));
    ...
    :host([checked]) :is(.checked, .disabled, .indeterminate) {
      background: var(--checkbox-fill-color, var(--nih-color-gold));
    }
