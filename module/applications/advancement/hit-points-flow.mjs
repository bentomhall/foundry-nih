...
export default class HitPointsFlow extends AdvancementFlow {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      template: "systems/nih/templates/advancement/hit-points-flow.hbs"
    });
  }
  ...
  _updateObject(event, formData) {
    ...
    throw new Advancement.ERROR(game.i18n.localize(`NIH.ADVANCEMENT.HitPoints.Warning.${errorType}`));
  }
