...
export default class AbilityScoreImprovementConfig extends AdvancementConfig {
  ...
  static PARTS = {
    ...super.PARTS,
    details: {
      template: "systems/nih/templates/advancement/ability-score-improvement-config-details.hbs"
    },
    scores: {
      template: "systems/nih/templates/advancement/ability-score-improvement-config-scores.hbs",
      templates: ["systems/nih/templates/advancement/parts/advancement-ability-score-control-v2.hbs"]
    }
  };
  ...
  async _prepareContext(options) {
    ...
    context.abilities = Object.entries(CONFIG.NIH.abilities).reduce((obj, [key, data]) => {
      ...
      obj[key] = {
        ...
        locked: {
          value: locked,
          hint: `NIH.ADVANCEMENT.AbilityScoreImprovement.FIELDS.locked.${locked ? "locked" : "unlocked"}`
        },
        value: fixed,
        canIncrease: true,
        canDecrease: true
    ...
    context.points = {
      ...
      label: game.i18n.localize("NIH.ADVANCEMENT.AbilityScoreImprovement.FIELDS.points.label"),
      min: 0,
