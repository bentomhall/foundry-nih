...
export default class ScaleValueConfig extends AdvancementConfig {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["nih", "advancement", "scale-value", "two-column"],
      template: "systems/nih/templates/advancement/scale-value-config.hbs",
      width: 540
    });
  }
  ...
  getData() {
    ...
    return foundry.utils.mergeObject(super.getData(), {
      ...
      movementUnits: CONFIG.NIH.movementUnits
    });
  }
  ...
  _prepareLevelData() {
    let lastValue = null;
    return Array.fromRange(CONFIG.NIH.maxLevel + 1).slice(1).reduce((obj, level) => {
  ...
  _onIdentifierHintCopy(event) {
    ...
    game.tooltip.activate(event.target, {text: game.i18n.localize("NIH.IdentifierCopied"), direction: "UP"});
  }
