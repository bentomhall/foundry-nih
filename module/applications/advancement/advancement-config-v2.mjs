...
export default class AdvancementConfig extends PseudoDocumentSheet {
  constructor(advancement={}, options={}) {
    if ( advancement instanceof nih.documents.advancement.Advancement ) {
  ...
  async _prepareContext(options) {
    const levels = Array.fromRange(CONFIG.NIH.maxLevel + 1).map(l => ({ value: l, label: l }));
    if ( ["class", "subclass"].includes(this.item.type) ) delete levels[0];
    else levels[0].label = game.i18n.localize("NIH.ADVANCEMENT.Config.AnyLevel");
    const context = {
