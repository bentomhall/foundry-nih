...
export default class AdvancementConfirmationDialog extends Dialog {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      template: "systems/nih/templates/advancement/advancement-confirmation-dialog.hbs",
      jQuery: false
    });
  }
  ...
  static forDelete(item) {
    return this.createDialog(
      item,
      game.i18n.localize("NIH.AdvancementDeleteConfirmationTitle"),
      game.i18n.localize("NIH.AdvancementDeleteConfirmationMessage"),
      {
  ...
  static forLevelDown(item) {
    return this.createDialog(
      item,
      game.i18n.localize("NIH.AdvancementLevelDownConfirmationTitle"),
      game.i18n.localize("NIH.AdvancementLevelDownConfirmationMessage"),
      {
        icon: '<i class="fas fa-sort-numeric-down-alt"></i>',
        label: game.i18n.localize("NIH.LevelActionDecrease")
      }
    );
  }
