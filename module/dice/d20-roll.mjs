...
export default class D20Roll extends BasicRoll {
  ...
  static _prepareMessageData(rolls, messageData) {
    ...
    const rtLabel = game.i18n.localize("NIH.FlagsReliableTalent");
    ...
    messageData.flavor ??= "";
    if ( advantage ) messageData.flavor += ` (${game.i18n.localize("NIH.Advantage")})`;
    else if ( disadvantage ) messageData.flavor += ` (${game.i18n.localize("NIH.Disadvantage")})`;
  }
