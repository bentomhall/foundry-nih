...
export default class DamageRoll extends Roll {
  ...
  configureDamage() {
    ...
    if ( this.options.powerfulCritical && (flatBonus > 0) ) {
      ...
      this.terms.push(new NumericTerm({number: flatBonus}, {flavor: game.i18n.localize("NIH.PowerfulCritical")}));
    }
  ...
  toMessage(messageData={}, options={}) {
    ...
    if ( this.isCritical ) {
      const label = game.i18n.localize("NIH.CriticalHit");
      ...
      new Dialog({
        ...
        buttons: {
          critical: {
            ...
            label: game.i18n.localize("NIH.CriticalHit"),
            callback: html => resolve(this._onDialogSubmit(html, true))
          },
          normal: {
            label: game.i18n.localize(allowCritical ? "NIH.Normal" : "NIH.Roll"),
