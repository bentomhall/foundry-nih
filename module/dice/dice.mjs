...
export async function damageRoll({
  ...
  const roll = new CONFIG.Dice.DamageRoll(formula, data, {
    ...
    criticalMultiplier,
    criticalBonusDamage,
    multiplyNumeric: multiplyNumeric ?? game.settings.get("nih", "criticalDamageModifiers"),
    powerfulCritical: powerfulCritical ?? game.settings.get("nih", "criticalDamageMaxDice")
  });
