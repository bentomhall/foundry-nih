...
export default class Combatant5e extends Combatant {
  ...
  async createTurnMessage({ deltas, periods, rolls }={}) {
     ...
     * @function nih.preCreateCombatMessage
     * @memberof hookEvents
     ...
     */
    Hooks.callAll("nih.preCreateCombatMessage", this, messageConfig);
  ...
  async recoverCombatUses(periods) {
     ...
     * @function nih.preCombatRecovery
     * @memberof hookEvents
     ...
     */
    if ( Hooks.call("nih.preCombatRecovery", this, periods) === false ) return;
     ...
     */
    if ( Hooks.call("nih.combatRecovery", this, periods, results) === false ) return;
     ...
     * @function nih.postCombatRecovery
     * @memberof hookEvents
     * @param {Combatant5e} combatant       Combatant that is being recovered.
     * @param {string[]} periods            Periods that were recovered.
     * @param {ChatMessage5e|void} message  Chat message created, if any.
     */
    Hooks.callAll("nih.postCombatRecovery", this, periods, message);
  }
