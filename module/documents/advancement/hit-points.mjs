...
export default class HitPointsAdvancement extends Advancement {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      ...
      typeIcon: "systems/nih/icons/svg/hit-points.svg",
      title: game.i18n.localize("NIH.ADVANCEMENT.HitPoints.Title"),
      hint: game.i18n.localize("NIH.ADVANCEMENT.HitPoints.Hint"),
      multiLevel: true,
      apps: {
  ...
  /** @inheritDoc */
  get levels() {
    return Array.fromRange(CONFIG.NIH.maxLevel + 1).slice(1);
  }
  ...
  #getApplicableValue(value) {
    const abilityId = CONFIG.NIH.defaultAbilities.hitPoints || "con";
