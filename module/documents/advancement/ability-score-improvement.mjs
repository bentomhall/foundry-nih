...
export default class AbilityScoreImprovementAdvancement extends Advancement {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      ...
      order: 20,
      icon: "systems/nih/icons/svg/ability-score-improvement.svg",
      title: game.i18n.localize("NIH.AdvancementAbilityScoreImprovementTitle"),
      hint: game.i18n.localize("NIH.AdvancementAbilityScoreImprovementHint"),
      ...
      if ( !itemData ) {
        ...
        if ( source ) {
          itemData = source.clone({
            ...
            "flags.nih.sourceId": data.featUuid,
