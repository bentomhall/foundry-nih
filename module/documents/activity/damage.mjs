...
export default class DamageActivity extends ActivityMixin(BaseDamageActivityData) {
  ...
  /** @inheritDoc */
  static LOCALIZATION_PREFIXES = [...super.LOCALIZATION_PREFIXES, "NIH.DAMAGE"];
  ...
  static metadata = Object.freeze(
    foundry.utils.mergeObject(super.metadata, {
      type: "damage",
      img: "systems/nih/icons/svg/activity/damage.svg",
      title: "NIH.DAMAGE.Title",
      hint: "NIH.DAMAGE.Hint",
