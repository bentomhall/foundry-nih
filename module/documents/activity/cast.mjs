...
export default class CastActivity extends ActivityMixin(BaseCastActivityData) {
   ...
   */
  static ENCHANTMENT_ID = staticID("nihspellchanges");

  /* -------------------------------------------- */

  /** @inheritDoc */
  static LOCALIZATION_PREFIXES = [...super.LOCALIZATION_PREFIXES, "NIH.CAST"];
  ...
  static metadata = Object.freeze(
    foundry.utils.mergeObject(super.metadata, {
      type: "cast",
      img: "systems/nih/icons/svg/activity/cast.svg",
      title: "NIH.CAST.Title",
      hint: "NIH.CAST.Hint",
  ...
  get cachedSpell() {
    return this.actor?.sourcedItems.get(this.spell.uuid)
      ?.find(i => i.getFlag("nih", "cachedFor") === this.relativeUUID);
  }
  ...
  async use(usage={}, dialog={}, message={}) {
     ...
     * @function nih.preUseLinkedSpell
     * @memberof hookEvents
     ...
     */
    if ( Hooks.call("nih.preUseLinkedSpell", this, usage, dialog, message) === false ) return;
     ...
     * @function nih.postUseLinkedSpell
     * @memberof hookEvents
     ...
     */
    if ( results ) Hooks.callAll("nih.postUseLinkedSpell", this, usage, results);
    ...
    return originalSpell.clone({
      effects: [
        ...originalSpell.effects.map(e => e.toObject()),
        {
          ...
          type: "enchantment",
          name: game.i18n.localize("NIH.CAST.Enchantment.Name"),
          img: "systems/nih/icons/svg/activity/cast.svg",
          origin: this.uuid,
