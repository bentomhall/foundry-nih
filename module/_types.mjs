 ...
 * @property {string} [travel]         Travel type in `CONFIG.NIH.travelTypes` to map this movement speed to. If not
 ...
 * @property {string} id       UUID of reference tool or ID within pack defined by `NIH.sourcePacks.ITEMS`.
 */
